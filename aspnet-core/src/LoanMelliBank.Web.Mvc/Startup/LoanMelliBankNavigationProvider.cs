...
namespace LoanMelliBank.Web.Startup
{
    ...
    /// </summary>
    public class LoanMelliBankNavigationProvider : NavigationProvider
    {
        public override void SetNavigation(INavigationProviderContext context)
        {
            context.Manager.MainMenu
                ...
                .AddItem(
                new MenuItemDefinition(PageNames.People,
                L("People"),
                url: "People",
                icon: "",
                requiredPermissionName: PermissionNames.Pages_People))
                .AddItem(
                    new MenuItemDefinition(
                        PageNames.About,
                        L("About"),
